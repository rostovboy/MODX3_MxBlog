...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('MxBlog\Model', MODX_CORE_PATH . 'components/mxblog/src/', null, 'MxBlog\\');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/mxblog/schema/mxblog.mysql.schema.xml';
